    ...
    return (
      <Card className="p-6">
        <p className="text-muted-foreground">
          Selecione uma empresa no topo da página para gerenciar importações de extrato.
        </p>
      </Card>
    )
  }
      ...
      >
        <Card className="p-6">
          <p className="text-sm text-muted-foreground">
            Os extratos bancários são importados (OFX/CSV) pela tela de{" "}
            <strong className="text-foreground">Contas</strong>, vinculados a cada
            conta bancária. Abaixo estão as importações já realizadas para esta empresa.
          </p>
          {error && (
            <div className="text-sm text-destructive bg-destructive/10 p-3 rounded mt-4">
              {error}
            </div>
          )}
        </Card>
